...
/**
 * Frontend utility class for validating export request parameters
...
public class ExportParameterValidator {
    ...
    /**
     * Validate all export parameters for frontend requests
     */
    public ValidationResult validateExportParameters(String reportType, String format, 
                                                   LocalDate startDate, LocalDate endDate) {
        logger.debug("Frontend validating export parameters - reportType: {}, format: {}, dateRange: {} to {}", 
        ...
        if (errors.isEmpty()) {
            logger.debug("Frontend export parameters validation successful");
            return new ValidationResult(true);
        } else {
            logger.warn("Frontend export parameters validation failed: {}", errors);
